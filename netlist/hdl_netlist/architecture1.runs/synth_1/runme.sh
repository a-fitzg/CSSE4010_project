...
HD_PWD='C:/Users/s4533087/CSSE4010/CSSE4010_project/netlist/hdl_netlist/architecture1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log architecture1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source architecture1.tcl
